...
architecture rtl of axis_fifo_b2 is
  ...
  constant data_width_c  : positive := 9+8;
  ...
  type reg_t is record
    ...
    m_emptied  : std_logic;
    axis_m_out : axis_m2s_b2i0d0u0_t;
  ...
  constant dflt_reg_c : reg_t := (
    ...
    m_transfer => '0',
    m_emptied  => '0',
    axis_m_out => dflt_axis_m2s_b2i0d0u0_c,
...
begin
  ...
  begin
    ...
    if (v.get_next = '1') then -- read next data from fifo and provide at axis_m_o
      ...
      v.axis_m_out.tdata  := rd_data_res(7+8 downto 0);
      v.axis_m_out.tstrb  := (others => '1');
      v.axis_m_out.tkeep  := (others => '1');
      v.axis_m_out.tlast  := rd_data_res(8+8);
    end if;
